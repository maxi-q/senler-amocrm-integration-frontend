...
const EditableTable = memo(({ data, changeData, toFields, fromFields, type='senler' }: IEditableTableProps) => {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '800px', margin: 'auto' }}>
      ...
      <p className="mt-1 mb-4 text-[0.8rem] text-left">⚠️ Максимум 2000 символов подробнее в <a className='text-blue-700 hover:text-blue-800 underline' href='https://help.senler.ru/senler/kanaly/vkontakte/integracii/integraciya-s-amocrm'>документации</a></p>
